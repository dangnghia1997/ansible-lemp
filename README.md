...
This playbook will install a LEMP environment on an Ubuntu 20.04 machine, as explained in the guide on
[How to Use Ansible to Install and Set Up LEMP on Ubuntu 20.04](https://www.digitalocean.com/community/tutorials/how-to-install-linux-nginx-mysql-php-lemp-stack-on-ubuntu-20-04).
...
ansible-playbook -i hosts -u  root php.yml
ansible-playbook -i hosts -u  root deploy.yml
```
